  ...
  return (
    ...
    >
      ...
      <div className="flex items-center px-2 py-3 border-b border-sidebar-border">
        <img src="/logo-lyss.png" alt="Lyss" className={cn("flex-shrink-0 object-contain brightness-150 contrast-125 drop-shadow-[0_0_10px_hsl(160,30%,46%,0.6)]", collapsed ? "h-8" : "h-10")} />
      </div>
