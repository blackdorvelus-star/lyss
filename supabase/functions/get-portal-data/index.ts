    ...
    return new Response(
      JSON.stringify({
        ...
        business: {
          ...
          // interac_answer is intentionally NOT returned to the client — security risk.
          // The answer is for the business owner's setup only; the client sets it in their banking app.
